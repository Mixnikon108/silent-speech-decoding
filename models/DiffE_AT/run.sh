...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_AT/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_AT/error.txt
##-------------------------------------
...
# ---- Training command ----
srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_AT/main.py --exp-dir /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_AT --dataset_file /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/BCI2020/BCI_processed.npz --dataset BCI --device cuda:0 --subject_id 2 --num_epochs 100 --batch_train 250  --batch_eval 32 --seed 42 --alpha 1  --num_classes 5 --channels 64 --n_T 100 --ddpm_dim 128 --encoder_dim 64 --fc_dim 64
