"""Data utilities: EEG preprocessing (padding, z-score normalization), Dataset/augmentations and dataloader builders."""
import numpy as np
...
def get_dataloader(
    ...
    train_transform = Compose([
        ...
        RandomTimeShift(max_shift=8),
        RandomScaling(scale_range=(0.95, 1.05))
        ])

    train_loader = DataLoader(EEGDataset(X_train, y_train, transform=train_transform),
