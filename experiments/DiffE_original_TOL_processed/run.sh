...
#SBATCH --job-name=DiffE_original_TOL_processed
...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_TOL_processed/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_TOL_processed/error.txt
##-------------------------------------
...
# ---- Training command ----
srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_mod/main.py --exp-dir /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_TOL_processed --dataset_file /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/TOL/TOL_processed.npz --dataset TOL --device cuda:0 --num_epochs 100 --batch_train 250  --subject_id 1 --batch_eval 32 --seed 42 --alpha 10  --num_classes 4 --channels 128 --n_T 100 --ddpm_dim 128 --encoder_dim 64 --fc_dim 64
