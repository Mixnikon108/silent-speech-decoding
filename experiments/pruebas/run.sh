...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/pruebas/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/pruebas/error.txt
##-------------------------------------
...
# ---- Training command ----
# srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_mod/main.py --exp-dir /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/pruebas --dataset_file /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/BCI2020/BCI_LP005.npz --dataset BCI --device cuda:0 --num_epochs 100 --batch_train 250  --subject_id 2 --batch_eval 32 --seed 42 --alpha 1  --num_classes 5 --channels 64 --n_T 100 --ddpm_dim 128 --encoder_dim 64 --fc_dim 64
srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/otherModels/main.py --n_time 512 --dataset_file /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/TOL/TOL_LP5.npz --dataset TOL --device cuda:0 --epochs 100 --subject_id 2 --n_channels 128 --n_classes 4 --out_csv /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/pruebas/benchmark_results.csv
