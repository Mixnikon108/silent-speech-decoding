...
#SBATCH --job-name=DiffE_original_BCI_raw_ALL
...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_BCI_raw_ALL/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_BCI_raw_ALL/error.txt
##-------------------------------------
...
# ---- Training command ----
srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/models/DiffE_mod/main.py --exp-dir /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/DiffE_original_BCI_raw_ALL --dataset_file /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/BCI2020/BCI_raw.npz --dataset BCI --device cuda:0 --num_epochs 100 --batch_train 250 --batch_eval 32 --seed 42 --alpha 10  --num_classes 5 --channels 64 --n_T 100 --ddpm_dim 128 --encoder_dim 64 --fc_dim 64
