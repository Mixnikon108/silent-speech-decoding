...
#SBATCH --job-name=otherModels_BCI_processed
...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/otherModels_BCI_processed/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/experiments/otherModels_BCI_processed/error.txt
##-------------------------------------
