"""
Entrenamiento de una CNN 1D (SimpleCNN) sobre EEG (BCI2020 / TOL) y análisis de
explicabilidad por canal: pesos de la primera convolución, saliency, grad×input y
permutation importance. Los resultados se guardan como CSV/NPY en el directorio de salida.
"""
