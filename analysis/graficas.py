"""
Comparación RAW vs procesado (BCI2020): espectro de frecuencia y señal temporal
del primer trial/canal. Guarda las figuras como PNG.
"""
...
file = 'ORCH_P1_BP1_N1_CAR1_ICA1_BL1_R0_L0.5_H125_b471c395'  # Cambia a 'RAW' o 'BP' según necesites

# Cargar datos RAW
raw_file = DATA_ROOT / "BCI_processed.npz"
X_train, y_train, X_val, y_val, X_test, y_test = load_data_BCI(raw_file, subject_id=1)

# Cargar datos PROCESADOS
processed_file = DATA_ROOT / f"BCI_{file}.npz"
