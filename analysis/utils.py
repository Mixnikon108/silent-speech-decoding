"""
Utilidades de datos para EEG: padding a múltiplo, normalización z-score por trial,
dataset PyTorch (EEGDataset), cargadores de los datasets BCI2020 y TOL, y creación
de DataLoaders para las particiones train/val/test.
"""
...
# ------------------------------------------------------------------
# Creadores de DataLoader para las tres particiones
# ------------------------------------------------------------------
def get_dataloader(
    X_train, y_train, X_val, y_val, X_test, y_test,
