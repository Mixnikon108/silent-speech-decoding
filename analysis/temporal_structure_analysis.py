"""
Análisis de estructura de la señal EEG (BCI2020): importancia de electrodos mediante
tests estadísticos por canal (Kruskal-Wallis + FDR, información mutua) y ablaciones de
identidad de canal, junto con diagnósticos de estructura temporal en la secuencia de
etiquetas (autocorrelación, runs test, MI temporal, clasificador solo-tiempo, CUSUM).
Los resultados se guardan como CSV/JSON en el directorio de salida.
"""
...
# ==== Configuración ====
# Directorio de datos relativo a la raíz del proyecto (data/processed/BCI2020/...)
DATA_ROOT = Path(__file__).resolve().parents[1] / "data" / "processed" / "BCI2020"
