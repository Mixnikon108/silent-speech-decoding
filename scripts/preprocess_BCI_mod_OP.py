#!/usr/bin/env python3
"""Build the BCI2020 dataset (raw/filtered/residual) with a configurable preprocessing pipeline via CLI."""
...
def parse_args():
    ...
    p.add_argument("--l-freq", type=float, default=None, help="Frecuencia de corte inferior (Hz) del filtro pasa-banda.")
