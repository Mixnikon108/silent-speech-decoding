...
processed_file = Path("/home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/BCI2020/BCI_processed.npz")
...
# Guardar figura
output_path = Path("./spectrum_comparison.png")  # Cambia la ruta si quieres otro destino
...
# Guardar figura
output_path_time = Path("./signal_comparison_channel0_trial0.png")
