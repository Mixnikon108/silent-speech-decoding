...
#SBATCH --output=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/analytics/output.txt
#SBATCH --error=/media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/analytics/error.txt
##-------------------------------------
...
srun python -u /media/beegfs/home/w314/w314139/PROJECT/silent-speech-decoding/analytics/cnn_test.py \
  --dataset BCI \
  --dataset_file /home/w314/w314139/PROJECT/silent-speech-decoding/data/processed/BCI2020/BCI_raw.npz \
  --subject_id 1 \
  --device cuda:0 \
  --epochs 100 \
  --batch_train 64 \
